...
# You'll notice that in Problem 2, your monthly payment had to be a multiple of $10. Why did
we make it that way? You can try running
# your code locally so that the payment can be any dollar and cent amount (in other words,
...
there are limits on
the amount of computing time each submission
...
we can pay off the
debt within a year. Try it out wit
...
def payingdebtoffinayear(balance_in, annual_interestrate):
    '''
    to count the lowest payment using bisection method
    '''
